...
exports.newInstance = function($, spec, cb) {
     ...
     *
     * The type of `caf.ruleType` is `"caf.simpleRule" | "caf.aggregateRule"`
     *
     * The type of `caf.rule` when the rule type is `"caf.simpleRule"`:
     *
     *      { type: caf.ruleType, ac: {caOwner: string=, caLocalName: string=},
     ...
     * `foo`.
     *
     * The type  of `caf.rule` when the rule type is `"caf.aggregateRule"`:
     *
     ...
     *
     * @return {caf.token|null} A parsed and validated token, or `null` if token
     *  invalid.
     *
     * @memberof! module:caf_security/proxy_security#
     * @alias verifyToken
