...
exports.clientInstance = function(user, passw) {
    ...
    that.login = function(helloServerReply) {
        var salt = hexToBuf(helloServerReply.saltHex);
        var valueB = hexToBuf(helloServerReply.valueBHex);
    ...
    that.newToken = function(tokenBundle, tokenConstr) {
        ...
        var pubKey = hexToBuf(tokenBundle.pubKeyHex);
...
exports.serverInstance = function(stateAll, prKey, puKey) {
    ...
    that.newToken = function(challenge, tokenConstr) {
        var valueA = hexToBuf(challenge.valueAHex);
        var m1 = hexToBuf(challenge.valueM1Hex);
        server.setA(valueA);
        server.checkM1(m1);
